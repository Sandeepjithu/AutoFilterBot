...
auth_channel = environ.get('AUTH_CHANNEL', '-1002058292472')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'movies_kottaaram')
UPDATE_CHANNEL = environ.get('UPDATE_CHANNEL', 'https://t.me/mk_movies_linkz') # add here your update channel link
